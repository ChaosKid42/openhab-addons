...
public class LuxtronikBindingConstants {
    ...
    public static final String CHANNEL_HEATPUMP_SWITCHOFF_ERROR_0 = "switchoff_error_0";
    public static final String CHANNEL_HEATPUMP_SWITCHOFF_ERROR_1 = "switchoff_error_1";
